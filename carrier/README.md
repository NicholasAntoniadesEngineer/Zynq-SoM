...
|   |   |   |   |
|---|---|---|---|
| [<img src="renders/ratsnest/board_aux.png" width="200" alt="board_aux">](renders/ratsnest/board_aux.png)<br>**board_aux** | [<img src="renders/ratsnest/board_qwiic.png" width="200" alt="board_qwiic">](renders/ratsnest/board_qwiic.png)<br>**board_qwiic** `wired` | [<img src="renders/ratsnest/board_qwiic 2.png" width="200" alt="board_qwiic 2">](renders/ratsnest/board_qwiic 2.png)<br>**board_qwiic 2** | [<img src="renders/ratsnest/board_services.png" width="200" alt="board_services">](renders/ratsnest/board_services.png)<br>**board_services** |
| [<img src="renders/ratsnest/board_services 2.png" width="200" alt="board_services 2">](renders/ratsnest/board_services 2.png)<br>**board_services 2** | [<img src="renders/ratsnest/bringup_en.png" width="200" alt="bringup_en">](renders/ratsnest/bringup_en.png)<br>**bringup_en** | [<img src="renders/ratsnest/bringup_en_modules.png" width="200" alt="bringup_en_modules">](renders/ratsnest/bringup_en_modules.png)<br>**bringup_en_modules** | [<img src="renders/ratsnest/bringup_modules.png" width="200" alt="bringup_modules">](renders/ratsnest/bringup_modules.png)<br>**bringup_modules** |
| [<img src="renders/ratsnest/bringup_modules 2.png" width="200" alt="bringup_modules 2">](renders/ratsnest/bringup_modules 2.png)<br>**bringup_modules 2** | [<img src="renders/ratsnest/bringup_rails.png" width="200" alt="bringup_rails">](renders/ratsnest/bringup_rails.png)<br>**bringup_rails** | [<img src="renders/ratsnest/bringup_rails 2.png" width="200" alt="bringup_rails 2">](renders/ratsnest/bringup_rails 2.png)<br>**bringup_rails 2** | [<img src="renders/ratsnest/camera.png" width="200" alt="camera">](renders/ratsnest/camera.png)<br>**camera** `wired` |
| [<img src="renders/ratsnest/debug_boot.png" width="200" alt="debug_boot">](renders/ratsnest/debug_boot.png)<br>**debug_boot** | [<img src="renders/ratsnest/ethernet.png" width="200" alt="ethernet">](renders/ratsnest/ethernet.png)<br>**ethernet** `wired` | [<img src="renders/ratsnest/fmc.png" width="200" alt="fmc">](renders/ratsnest/fmc.png)<br>**fmc** `wired` | [<img src="renders/ratsnest/fmc 2.png" width="200" alt="fmc 2">](renders/ratsnest/fmc 2.png)<br>**fmc 2** |
| [<img src="renders/ratsnest/hdmi_rx.png" width="200" alt="hdmi_rx">](renders/ratsnest/hdmi_rx.png)<br>**hdmi_rx** `wired` | [<img src="renders/ratsnest/hdmi_rx_term.png" width="200" alt="hdmi_rx_term">](renders/ratsnest/hdmi_rx_term.png)<br>**hdmi_rx_term** `wired` | [<img src="renders/ratsnest/hdmi_tx.png" width="200" alt="hdmi_tx">](renders/ratsnest/hdmi_tx.png)<br>**hdmi_tx** `wired` | [<img src="renders/ratsnest/lcd.png" width="200" alt="lcd">](renders/ratsnest/lcd.png)<br>**lcd** `wired` |
| [<img src="renders/ratsnest/mechanical.png" width="200" alt="mechanical">](renders/ratsnest/mechanical.png)<br>**mechanical** | [<img src="renders/ratsnest/mechanical 2.png" width="200" alt="mechanical 2">](renders/ratsnest/mechanical 2.png)<br>**mechanical 2** | [<img src="renders/ratsnest/microsd.png" width="200" alt="microsd">](renders/ratsnest/microsd.png)<br>**microsd** `wired` | [<img src="renders/ratsnest/motor_pwm.png" width="200" alt="motor_pwm">](renders/ratsnest/motor_pwm.png)<br>**motor_pwm** `wired` |
| [<img src="renders/ratsnest/motor_sense.png" width="200" alt="motor_sense">](renders/ratsnest/motor_sense.png)<br>**motor_sense** `wired` | [<img src="renders/ratsnest/pd_input.png" width="200" alt="pd_input">](renders/ratsnest/pd_input.png)<br>**pd_input** `wired` | [<img src="renders/ratsnest/pmod.png" width="200" alt="pmod">](renders/ratsnest/pmod.png)<br>**pmod** `wired` | [<img src="renders/ratsnest/pmod 2.png" width="200" alt="pmod 2">](renders/ratsnest/pmod 2.png)<br>**pmod 2** |
| [<img src="renders/ratsnest/pmod_expansion.png" width="200" alt="pmod_expansion">](renders/ratsnest/pmod_expansion.png)<br>**pmod_expansion** `wired` | [<img src="renders/ratsnest/power.png" width="200" alt="power">](renders/ratsnest/power.png)<br>**power** `wired` | [<img src="renders/ratsnest/power 2.png" width="200" alt="power 2">](renders/ratsnest/power 2.png)<br>**power 2** | [<img src="renders/ratsnest/power_mon.png" width="200" alt="power_mon">](renders/ratsnest/power_mon.png)<br>**power_mon** `wired` |
| [<img src="renders/ratsnest/power_som.png" width="200" alt="power_som">](renders/ratsnest/power_som.png)<br>**power_som** `wired` | [<img src="renders/ratsnest/power_som 2.png" width="200" alt="power_som 2">](renders/ratsnest/power_som 2.png)<br>**power_som 2** | [<img src="renders/ratsnest/rj45_connector.png" width="200" alt="rj45_connector">](renders/ratsnest/rj45_connector.png)<br>**rj45_connector** | [<img src="renders/ratsnest/som 2.png" width="200" alt="som 2">](renders/ratsnest/som 2.png)<br>**som 2** |
| [<img src="renders/ratsnest/uart_bridge.png" width="200" alt="uart_bridge">](renders/ratsnest/uart_bridge.png)<br>**uart_bridge** `wired` | [<img src="renders/ratsnest/uart_bridge 2.png" width="200" alt="uart_bridge 2">](renders/ratsnest/uart_bridge 2.png)<br>**uart_bridge 2** | [<img src="renders/ratsnest/usb_jtag.png" width="200" alt="usb_jtag">](renders/ratsnest/usb_jtag.png)<br>**usb_jtag** `wired` | [<img src="renders/ratsnest/usb_jtag_connector.png" width="200" alt="usb_jtag_connector">](renders/ratsnest/usb_jtag_connector.png)<br>**usb_jtag_connector** `wired` |
| [<img src="renders/ratsnest/usb_pd.png" width="200" alt="usb_pd">](renders/ratsnest/usb_pd.png)<br>**usb_pd** `wired` | [<img src="renders/ratsnest/usb_pd 2.png" width="200" alt="usb_pd 2">](renders/ratsnest/usb_pd 2.png)<br>**usb_pd 2** | [<img src="renders/ratsnest/usb_uart_connector.png" width="200" alt="usb_uart_connector">](renders/ratsnest/usb_uart_connector.png)<br>**usb_uart_connector** `wired` | [<img src="renders/ratsnest/usb_uart_connector 2.png" width="200" alt="usb_uart_connector 2">](renders/ratsnest/usb_uart_connector 2.png)<br>**usb_uart_connector 2** |
| [<img src="renders/ratsnest/usbc_otg.png" width="200" alt="usbc_otg">](renders/ratsnest/usbc_otg.png)<br>**usbc_otg** `wired` | [<img src="renders/ratsnest/user_io.png" width="200" alt="user_io">](renders/ratsnest/user_io.png)<br>**user_io** |   |   |
