...
* U1 (TCA9535PWR, I2C addr 0x20 — A0=A1=A2=GND; FUSB302B at 0x22 shares the
  ...
  raises it); P11..P17 have no internal pulls and must not float: 100k to
  GND each. SDA/SCL ride STM32_I2C2 (usb_pd's FUSB302 bus) with 4k7
  pull-ups to +3V3_SC (dossier risk R1: the bus must live before any
  carrier rail). INT# is open-drain: 10k to +3V3_SC, port
  STM32_BRINGUP_INT (J3 GPIO4 function map, wave-3 deferral).
