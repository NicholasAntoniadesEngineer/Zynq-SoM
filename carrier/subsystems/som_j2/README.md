...
in the shared generator `carrier/som_conn_gen.py`. The pin→net map for J2's 100
signal pins comes from `carrier/som_interface.json` (extracted from the SoM
...
```
pytest carrier/subsystems/som_j2/test_som_j2.py
```
