...
| LM61460AANRJRR (U1) | power | +VIN_SYS -> +5V_REG | 2.950 | ~1.64 W |
...
- **(16) power**: Buck thermal (worst-case declared draws): LM61460AANRJRR +5V_REG ~1.64 W; TPS54302DDCR +3V3_REG ~0.97 W. Pour copper on the SW/PGND side, stitch vias under the packages, keep each SW node loop minimal.
