...
- block sizes: per-part courtyards (`parts/<MPN>/<MPN>.kicad_mod` F.CrtYd; KiCad-standard footprints from the dims in their names), big parts raw + small parts x2.15 routing factor
...
|---|---|---|---|---|
| N | ethernet | (10.5, 0, 12 x 17.5) | RESERVED: rj45_connector (deferred) | (1) |
| N | microsd | (29, 0, 18.5 x 18) | TF-01A (microSD push-pull) | (2) |
| N | pd_input | (54, 0, 12 x 19.5) | TYPE-C-31-M-12 (USB-C receptacle) | (3) |
| N | uart_bridge | (73, 0, 12 x 5.5) | RESERVED: usb_uart_connector (deferred) | (4) |
...
|---|---|---|---|---|---|
| bringup_en | E | (92, 14, 11.5 x 8) | 15 | 91.6 |  |
| bringup_en_modules | E | (90, 62, 23 x 14.5) | 54 | 333.2 |  |
| bringup_modules | E | (90, 24, 24.5 x 15) | 70 | 364.3 | (12) |
| bringup_rails | E | (88, 42, 27.5 x 17) | 25 | 463.9 | (13) |
| debug_boot | N | (68, 8, 22 x 13.5) | 10 | 294.4 | (14) |
| power | E | (18, 42, 14 x 22.5) | 35 | 312 | (15) |
| power_mon | E | (106, 6, 9.5 x 15) | 10 | 142.5 | (16) |
| usb_pd | @pd_input | (24, 20, 8 x 8) | 7 | 29.9 | (17) |
| user_io | S | (12, 70, 21.5 x 13.5) | 17 | 290.1 | (18) |
...
| TPS26631PWPR (U1) | pd_input | +VBUS_IN -> +VIN | 1.256 | negligible |
...
- **(15) power**: Buck thermal (worst-case declared draws): TPS54302DDCR +5V ~1.51 W; TPS54302DDCR +3V3 ~0.85 W. Pour copper on the SW/PGND side, stitch vias under the packages, keep each SW node loop minimal.
...
- **(board)**: 48 test points board-wide (test-point gate): spread them with probe clearance as the blocks settle; none may end up under the SoM.
