...
- block sizes: per-part courtyards (`parts/<MPN>/<MPN>.kicad_mod` F.CrtYd; KiCad-standard footprints from the dims in their names), big parts raw + small parts x1.32 routing factor
...
|---|---|---|---|---|
| N | ethernet | (7.5, 0, 12 x 14.5) | RESERVED: rj45_connector (deferred) | (1) |
| N | microsd | (23.5, 0, 18.5 x 18) | TF-01A (microSD push-pull) | (2) |
| N | pd_input | (45.5, 0, 12 x 15) | TYPE-C-31-M-12 (USB-C receptacle) | (3) |
| N | uart_bridge | (61.5, 0, 12 x 3.5) | RESERVED: usb_uart_connector (deferred) | (4) |
