...
Derived board: **165 x 145 mm**; SoM origin at **(57.5, 51.5)** (centered). All coordinates below are board-frame mm, origin top-left, +y down (KiCad convention).

Outline derivation: SoM 50x42 + 6mm halo + 11mm connector band/edge -> core 84x76; component area 5120mm2 / 0.6 fill -> area floor 115x104; + 3mm perimeter keepout -> 125x110 mm (rounded up to 5mm grid); then SMALLEST-AREA search over aspects 1, 1.1, 1.1364, 1.2, 1.3, 1.4 -> 165x145 mm (the smallest board holding the REAL 2-sided packed blocks with the estimated cross-subsystem airwire 13689 <= LAW-5 budget 13921 mm — honest routing headroom, the gate is not relaxed), SoM 50x42 centered.

## Edge connectors (pinned to edges by their mating direction)

| edge | sheet | block (x, y, w x h) | connector(s) | notes |
|---|---|---|---|---|
| N | microsd | (48, 1.5, 20.97 x 25.001) | TF-01A (microSD push-pull) | (1) |
| N | pd_input | (69.5, 1.5, 23.51 x 24.21) | TYPE-C-31-M-12 (USB-C receptacle) | (2) |
| N | usbc_otg | (93.5, 1.5, 17.16 x 16.938) | TYPE-C-31-M-12 (USB-C receptacle) | (3) |
| N | usb_jtag_connector | (111, 1.5, 11.35 x 16.938) | TYPE-C-31-M-12 (USB-C receptacle) | (4) |
| N | usb_uart_connector | (122.5, 1.5, 11.35 x 16.938) | TYPE-C-31-M-12 (USB-C receptacle) | (5) |
...
| E | rj45_connector | (135.5, 55.5, 28.07 x 19.8) |  |  |
| E | board_qwiic | (150.5, 75.5, 13.026 x 7.9) |  |  |
| S | hdmi_rx | (30.5, 119.5, 17.97 x 24.036) | HDMI-019S (HDMI receptacle) | (8) |
| S | hdmi_tx | (49, 119, 20.97 x 24.546) | HDMI-019S (HDMI receptacle) | (9) |
| S | pmod | (70.5, 119, 34.94 x 24.609) | DS1024-2x6R2 (PMOD 2x6 socket), DS1024-2x6R2 (PMOD 2x6 socket) | (10) |
| S | pmod_expansion | (105.5, 114, 25.59 x 29.633) | DS1024-2x6R2 (PMOD 2x6 socket) | (11) |

## Interior blocks (zone = dominant SoM connector side, or the power cluster)

| sheet | anchor | block (x, y, w x h) | parts | est mm2 | notes |
|---|---|---|---|---|---|
| board_aux | E | (58, 34, 12.08 x 16.544) | 17 | 199.9 |  |
| board_services | W | (19, 94, 23.2 x 22.4) | 9 | 519.7 |  |
| bringup_en | E | (80, 38, 10.68 x 12.2) | 15 | 130.3 |  |
| bringup_en_modules | E | (85, 95, 19.7 x 23.6) | 54 | 464.9 |  |
| bringup_modules | E | (64, 94, 19.7 x 19.866) | 70 | 391.4 | (12) |
| bringup_rails | E | (132, 84, 19.7 x 52.03) | 23 | 1025 | (13) |
| debug_boot | N | (38, 35, 18.15 x 30.944) | 10 | 561.6 | (14) |
| ethernet | @rj45_connector | (92, 30, 14.7 x 21.06) | 10 | 309.6 | (15) |
| fmc | S | (108, 46, 15.89 x 53.31) | 8 | 847.1 | (16) |
| hdmi_rx_term | @hdmi_rx | (55, 99, 8.27 x 11.6) | 10 | 95.9 |  |
| mechanical | E | (111, 100, 13 x 13) | 4 | 169 |  |
| power | E | (125, 26, 20.51 x 28.16) | 51 | 577.6 | (17) |
| power_mon | E | (125, 55, 9.54 x 15.228) | 10 | 145.3 | (18) |
| power_som | E | (146, 37, 14.62 x 17.26) | 23 | 252.3 |  |
| uart_bridge | @rj45_connector | (71, 41, 8.27 x 9.94) | 10 | 82.2 | (19) |
| usb_jtag | E | (108, 20, 15.62 x 25.47) | 19 | 397.8 |  |
| usb_pd | @pd_input | (82, 29, 8.27 x 7.78) | 6 | 64.3 | (20) |
| user_io | S | (43, 67, 13.35 x 31.2) | 17 | 416.5 | (21) |
