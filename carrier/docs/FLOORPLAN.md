...
- block sizes: per-part courtyards (`parts/<MPN>/<MPN>.kicad_mod` F.CrtYd; KiCad-standard footprints from the dims in their names), big parts raw + small parts x2.53 routing factor
...
|---|---|---|---|---|
| N | ethernet | (10.5, 0, 12 x 12) | RESERVED: rj45_connector (deferred) | (1) |
| N | microsd | (29, 0, 18.5 x 18) | TF-01A (microSD push-pull) | (2) |
| N | pd_input | (54, 0, 12 x 12.5) | TYPE-C-31-M-12 (USB-C receptacle) | (3) |
| N | uart_bridge | (73, 0, 12 x 6) | RESERVED: usb_uart_connector (deferred) | (4) |
| N | usbc_otg | (91.5, 0, 12 x 11) | TYPE-C-31-M-12 (USB-C receptacle) | (5) |
| W | fmc | (0, 5.5, 16 x 60.5) | ASP-134603-01 (FMC LPC (VITA 57.1)) | (6) |
| W | lcd | (0, 67.5, 10 x 29) | AFC07-S40FCA-00 (FFC 40-pin 0.5mm (LCD)) | (7) |
...
|---|---|---|---|---|---|
| bringup_en | E | (74, 74, 13.5 x 8) | 15 | 107.8 |  |
| bringup_en_modules | E | (18, 34, 14 x 23) | 44 | 320.2 |  |
| bringup_modules | E | (90, 62, 23.5 x 14.5) | 56 | 342.9 | (12) |
| bringup_rails | E | (88, 42, 27.5 x 17) | 26 | 468 | (13) |
| debug_boot | N | (68, 8, 22 x 14) | 10 | 308.6 | (14) |
| power | E | (90, 26, 24 x 14.5) | 35 | 344.5 | (15) |
| power_mon | E | (94, 14, 17 x 10) | 10 | 167.6 | (16) |
| usb_pd | @pd_input | (56, 14, 8 x 8) | 7 | 35.2 | (17) |
| user_io | S | (18, 60, 14.5 x 23.5) | 17 | 341.3 | (18) |
...
| TPS54302DDCR (U1) | power | +VIN -> +5V | 2.210 | ~1.23 W |
...
- **(12) bringup_modules**: 8 SY6280 load-switch cells; each gated rail (+3V3_CAM, +3V3_HDMI_RX, +3V3_HDMI_TX, +3V3_LCD, +3V3_PMOD, +3V3_SD, +3V3_USER_LED, +5V_USB) stars from its switch — place this block centrally so every gated rail leaves toward its module without crossing the others.
...
- **(15) power**: Buck thermal (worst-case declared draws): TPS54302DDCR +5V ~1.23 W; TPS54302DDCR +3V3 ~0.85 W. Pour copper on the SW/PGND side, stitch vias under the packages, keep each SW node loop minimal.
...
- **(board)**: 43 test points board-wide (test-point gate): spread them with probe clearance as the blocks settle; none may end up under the SoM.
