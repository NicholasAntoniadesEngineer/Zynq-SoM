...
Generated: 2026-05-25T18:50:22Z

**Errors:** 37  **Warnings:** 50  **Info:** 0

## Errors (37)

- **page_bounds.symbol_outside**: symbol '#PWR125' ('CHASSIS_GND') outside page: x=293.37 > right edge 291.92 _(usb_pd.kicad_sch)_
- **page_bounds.wire_outside**: wire end outside page: x=293.37 > right edge 291.92 _(usb_pd.kicad_sch)_
- **page_bounds.symbol_outside**: symbol '#PWR111' ('CHASSIS_GND') outside page: x=293.37 > right edge 291.92 _(usbc_otg.kicad_sch)_
- **page_bounds.wire_outside**: wire end outside page: x=293.37 > right edge 291.92 _(usbc_otg.kicad_sch)_
- **overlap.coincident_symbol**: symbols 'C101' and 'C104' share the same anchor (132.08, 21.59) _(uart_bridge.kicad_sch)_
...
- **erc.pin_to_pin**: Pins of type Output and Output are connected _(carrier.kicad_sch)_
...
- **erc.isolated_pin_label**: Label connected to only one pin _(carrier.kicad_sch)_
- **erc.label_multiple_wires**: Label connects more than one wire at 1028700, 495300 _(carrier.kicad_sch)_
- **erc.isolated_pin_label**: Label connected to only one pin _(carrier.kicad_sch)_
- **erc.isolated_pin_label**: Label connected to only one pin _(carrier.kicad_sch)_
- **erc.isolated_pin_label**: Label connected to only one pin _(carrier.kicad_sch)_
- **erc.isolated_pin_label**: Label connected to only one pin _(carrier.kicad_sch)_
...
- **erc.isolated_pin_label**: Label connected to only one pin _(carrier.kicad_sch)_
- **erc.label_multiple_wires**: Label connects more than one wire at 2235200, 787400 _(carrier.kicad_sch)_
- **erc.footprint_link_issues**: Footprint 'FX10A-168P-SV1' not found in library 'Connector_FFC-FPC' _(carrier.kicad_sch)_
- **erc.label_multiple_wires**: Label connects more than one wire at 977900, 520700 _(carrier.kicad_sch)_
- **erc.label_multiple_wires**: Label connects more than one wire at 2641600, 457200 _(carrier.kicad_sch)_
- **erc.footprint_link_issues**: The current configuration does not include the footprint library 'Connector_HDMI' _(carrier.kicad_sch)_
...
- **erc.footprint_link_issues**: Footprint 'FX10A-168P-SV1' not found in library 'Connector_FFC-FPC' _(carrier.kicad_sch)_
- **erc.multiple_net_names**: Both STM32_USBOTG_VBUS_EN and STM32_USBOTG_OC_N are attached to the same items; STM32_USBOTG_VBUS_EN will be used in the netlist _(carrier.kicad_sch)_
- **erc.multiple_net_names**: Both GND and USBOTG_DP are attached to the same items; GND will be used in the netlist _(carrier.kicad_sch)_
- **erc.pin_to_pin**: Pins of type Bidirectional and Power output are connected _(carrier.kicad_sch)_
- **erc.pin_to_pin**: Pins of type Bidirectional and Power output are connected _(carrier.kicad_sch)_
- **erc.pin_to_pin**: Pins of type Bidirectional and Power output are connected _(carrier.kicad_sch)_
- **erc.pin_to_pin**: Pins of type Bidirectional and Power output are connected _(carrier.kicad_sch)_
- **erc.multiple_net_names**: Both GND and ZYNQ_HDMI_RX_SDA are attached to the same items; GND will be used in the netlist _(carrier.kicad_sch)_
...
- **erc.multiple_net_names**: Both ZYNQ_PS_UART0_CTS_N and ZYNQ_PS_UART0_RXD are attached to the same items; ZYNQ_PS_UART0_CTS_N will be used in the netlist _(carrier.kicad_sch)_
...
- **erc.pin_to_pin**: Pins of type Bidirectional and Power output are connected _(carrier.kicad_sch)_
- **erc.pin_to_pin**: Pins of type Bidirectional and Power output are connected _(carrier.kicad_sch)_
- **erc.multiple_net_names**: Both GND and ZYNQ_HDMI_TX_TMDS_2_P are attached to the same items; GND will be used in the netlist _(carrier.kicad_sch)_
