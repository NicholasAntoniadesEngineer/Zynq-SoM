// Frozen loader and independent geometry/mutation assertions copied from
// pcb_stage_contracts.cpp at 6a580efe. No existing reference fixture is edited.
#include "schgen/pcb_stage_templates.hpp"
#include <iostream>
#include <limits>
#include <stdexcept>

namespace stage_reference {
