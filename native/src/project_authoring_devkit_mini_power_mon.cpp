...
// Migrated construction operations from devkit_mini/subsystems/power_mon/power_mon.py.
CircuitSheetIr devkit_mini_power_mon(const SubsystemMeta& meta, const AuthoringContext& context) {
