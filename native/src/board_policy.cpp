...
const std::vector<Binding> placement_bindings{
    ...
    {"compose_channel_min_nets","compose::channel_min_nets"},
    {"compose_channel_floor","compose::channel_floor"},
    {"compose_channel_per_net","compose::channel_per_net"},
    {"compose_hop_weight","compose::hop_weight"},
    {"compose_seed_weight","compose::seed_weight"},
    {"floorplan_svg_origin_x","svg::ox"},
    {"floorplan_svg_origin_y","svg::oy"},
    {"floorplan_svg_scale","svg::scale"},
    {"escape_construct_radius","escape::radius"},
    {"escape_lattice","escape::lattice"},
    {"escape_lane_handle","escape::lane_handle"},
    {"escape_hole_clearance","escape::hole_hole"},
