...
// Migrated construction operations from devkit_mini/subsystems/mechanical/mechanical.py.
CircuitSheetIr devkit_mini_mechanical(const SubsystemMeta& meta, const AuthoringContext& context) {
