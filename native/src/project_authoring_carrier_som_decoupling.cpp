...
// Migrated construction operations from carrier/subsystems/som_decoupling/som_decoupling.py.
CircuitSheetIr carrier_som_decoupling(const SubsystemMeta& meta, const AuthoringContext& context) {
