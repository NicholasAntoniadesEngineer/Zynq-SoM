...
// Migrated construction operations from carrier/subsystems/power_som/power_som.py.
CircuitSheetIr carrier_power_som(const SubsystemMeta& meta, const AuthoringContext& context) {
