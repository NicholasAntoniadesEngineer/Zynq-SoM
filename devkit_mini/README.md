...
|   |   |   |   |
|---|---|---|---|
| [<img src="renders/ratsnest/debug_boot.png" width="200" alt="debug_boot">](renders/ratsnest/debug_boot.png)<br>**debug_boot** | [<img src="renders/ratsnest/mechanical.png" width="200" alt="mechanical">](renders/ratsnest/mechanical.png)<br>**mechanical** | [<img src="renders/ratsnest/pd_input.png" width="200" alt="pd_input">](renders/ratsnest/pd_input.png)<br>**pd_input** `wired` | [<img src="renders/ratsnest/power.png" width="200" alt="power">](renders/ratsnest/power.png)<br>**power** `wired` |
