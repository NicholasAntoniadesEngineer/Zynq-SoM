"""som_j1 — SoM mezzanine connector J1, GENERATED from devkit_mini/som_interface.json.

Power/USB/STM32/JTAG/SDIO/ethernet-MDI contract pins; every pin bound to its
contract net verbatim (see devkit_mini/som_conn_gen.py for the layout + rules).
...
# foldered package layout: this file is devkit_mini/subsystems/som_j1/som_j1.py,
